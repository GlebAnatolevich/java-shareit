...
public class BookingServiceImpl implements BookingService {
    ...
    public List<BookingDto> getBookingsByOwner(Long userId, State state) {
        ...
        List<Booking> bookingList = switch (state) {
            ...
            case CURRENT -> bookingRepository.findAllByItemOwnerAndStartBeforeAndEndAfter(user, LocalDateTime.now(),
                    LocalDateTime.now(), sort);
            case PAST -> bookingRepository.findAllByItemOwnerAndEndBefore(user, LocalDateTime.now(), sort);
    ...
    public List<BookingDto> getBookingsByUser(Long userId, State state) {
        ...
        List<Booking> bookingList = switch (state) {
            ...
            case CURRENT -> bookingRepository.findAllByBookerAndStartBeforeAndEndAfter(user,
                    LocalDateTime.now(), LocalDateTime.now(), sort);
            case PAST -> bookingRepository.findAllByBookerAndEndBefore(user,
                    LocalDateTime.now(), sort);
